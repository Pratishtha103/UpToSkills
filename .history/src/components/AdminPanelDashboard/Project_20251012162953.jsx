          ...
          ? Array.from({ length: 6 }).map((_, idx) => (
              <div // Skeleton loader
                ...
                className={`stat-card p-6 animate-pulse rounded-lg ${
                  isDarkMode
                    ? "bg-gray-800" // Dark mode skeleton color
                    : "bg-white" // Light mode skeleton color
                }`}
              />
            ))
          : projects.map((project) => (
              <div // Changed from motion.div
                ...
                className={`stat-card p-6 rounded-lg transition-colors duration-300 ${
                  isDarkMode
                    ? "bg-gray-800 text-white" // Card BG and main text color
              ...
              >
                ...
                <div
                  className={`flex flex-col gap-2 mb-4 text-sm transition-colors duration-300 ${
                    isDarkMode ? "text-gray-300" : "text-gray-700" // Sub-text color
                  }`}
                >
                  <div className={`flex items-center gap-2`}>
                    <User
                      className={`w-4 h-4 ${
                        isDarkMode ? "text-white" : "text-gray-700" // Icon color
                      }`}
                    />
