        ...
        {loading
          ...
          : projects.map((project) => (
              <div // Project Card (Standard div)
                ...
                className={`stat-card p-6 rounded-lg transition-colors duration-300 ${
                  isDarkMode
                    ? "bg-gray-800 !text-white" // 💡 AGGRESSIVE FIX: Forced text-white
                    : "bg-white text-gray-900"
                }`}
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  {/* Title now inherits the forced color */}
                  <h3 className="text-lg font-bold transition-colors duration-300">
                    {project.project_title}
                  </h3>
                </div>
                ...
                <div
                  className={`flex flex-col gap-2 mb-4 text-sm transition-colors duration-300 ${
                    // Subdued color for details
                    isDarkMode ? "text-gray-300" : "text-gray-700"
                  }`}
                >
                  <div className={`flex items-center gap-2`}>
                    <User
                      className={`w-4 h-4 ${isDarkMode ? "text-white" : ""}`} // 💡 FIX: Ensure icon is visible against dark BG
                    />
                    Mentor: {project.mentor_name}
                  </div>
                  <div className="flex items-center gap-2">
