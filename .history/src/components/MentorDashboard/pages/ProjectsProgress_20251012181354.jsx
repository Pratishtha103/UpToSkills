...
const ProjectsProgress = ({ isDarkMode, setIsDarkMode }) => {
  return (
    <div className="mt-14 flex min-h-screen">
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors min-h-screen">
        {/* Page header */}
        ...
        {/* Students Table */}
        <div className="bg-white dark:bg-gray-800 shadow-lg dark:shadow-xl rounded-2xl p-6 mx-8 transition-colors">
