      ...
      <main className="flex-grow relative z-10 pb-20">
        ...
        <section className="text-center mt-28 mb-12 px-4">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed mb-3">
            Learn to defend systems, networks, and data from cyber threats. Gain hands-on experience with ethical hacking, malware analysis, and digital forensics to secure the modern world.
          </p>
          <p className="text-lg font-semibold text-indigo-600">
            Join us and master the art of cybersecurity defense.
          </p>
        </section>
        ...
        <div className="max-w-4xl mx-auto bg-white/60 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-blue-100 mb-12 transform transition hover:scale-[1.01]">
          <p className="text-gray-700 leading-relaxed">
            <span className="font-bold text-blue-600">Skills:</span> Network Security • Ethical Hacking • Threat Analysis • Cryptography • Malware Detection • Wireshark & Kali Linux • Risk Management
          </p>
        </div>
