...
const Datascience = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    course: "data-science", date: currentDate, time: currentTime,
  });
    ...
    <div className={`min-h-screen flex flex-col relative overflow-hidden transition-colors duration-300 ${darkMode ? "bg-gray-900" : "bg-gradient-to-br from-blue-50 via-white to-indigo-50"}`}>
      ...
      <main className="flex-grow relative z-10 pb-20">
        <section className="text-center mt-28 mb-12 px-4">
          <h1 className="text-5xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-5 drop-shadow-sm">Data Science</h1>
          <p className={`max-w-3xl mx-auto text-lg leading-relaxed mb-3 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>Dive into the world of Data Science! Learn to analyze data, build predictive models, and extract insights using Python, SQL, and machine learning.</p>
          <p className="text-lg font-semibold text-indigo-500">Join us and unlock the power of data-driven intelligence.</p>
        </section>
        ...
        <div className={`max-w-4xl mx-auto backdrop-blur-md rounded-2xl p-6 shadow-lg mb-12 transform transition hover:scale-[1.01] ${darkMode ? "bg-gray-800/60 border-gray-700" : "bg-white/60 border-blue-100"} border`}>
          <p className={`leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
            <span className="font-bold text-blue-500">Skills:</span> Python (Pandas, NumPy, Matplotlib, Seaborn) • SQL • Machine Learning • Data Visualization • Predictive Modeling • Real-world Data Handling
          </p>
        </div>
        ...
        <div className="grid max-w-7xl mx-auto px-6 items-center">
          ...
          >
            <div className={`backdrop-blur-md p-10 rounded-3xl shadow-2xl transition-all duration-300 ${darkMode ? "bg-gray-800/80 border-gray-700" : "bg-white/80 border-blue-100"} border hover:shadow-[0_10px_40px_rgba(59,130,246,0.2)]`}>
              <h2 className={`text-3xl font-bold mb-8 text-center ${darkMode ? "text-white" : "text-gray-800"}`}>Apply for Data Science</h2>
              <div className="space-y-6">
                ...
                <div className="relative">
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} onBlur={handleEmailBlur} placeholder=" " required className={inputClass} />
